...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   fetchCityImage: () => (/* binding */ fetchCityImage)\n/* harmony export */ });\nconst accessKey = 'aXOEhmNt97hkxUSGmB7imXmDjQ3OCVSuq8mj0WfoxTk';\r\n\r\nfunction fetchCityImage(city) {\r\n    return fetch(`https://api.unsplash.com/search/photos?query=${city}&client_id=${accessKey}`)\r\n        .then(response => response.json())\r\n        .then(data => {\r\n            if (data.results.length > 0) {\r\n                const imageUrl = data.results[0].urls.regular;\r\n                document.body.style.backgroundImage = `url(${imageUrl})`;\r\n            } else {\r\n                console.log('No images found for this city');\r\n            }\r\n        })\r\n        .catch(error => {\r\n            console.error('Error fetching image:', error);\r\n        });\r\n}\n\n//# sourceURL=webpack://odin-weather/./src/background.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   fetchWeather: () => (/* binding */ fetchWeather)\n/* harmony export */ });\n// this file should only be responsibile for fetching the data and returning it. also segregating the data into lists.\r\n\r\n// we need these data. 1) hourly weather, 2) daily weather, 3) current weather, 4) \r\n\r\nfunction fetchWeather(name) {\r\n\r\n\r\n    fetch(`https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${name}?unitGroup=metric&key=Z8M4YEMGN8FKPH28Q46CXZSDB&contentType=json`, { mode: 'cors' })\r\n      .then(function(response) {\r\n        return response.json();\r\n      })\r\n      .then(function(data) {\r\n        let target = document.getElementById('target');\r\n        let cond = document.getElementById('condition');\r\n        let temp = document.getElementById('temperature');\r\n        let fl = document.getElementById('feels-like');\r\n        let wind = document.getElementById('wind');\r\n        let humid = document.getElementById('humidity');\r\n\r\n        target.innerText = data.address.toUpperCase();\r\n        cond.innerText = data.currentConditions.conditions;\r\n        temp.innerHTML = `${data.currentConditions.dew}<span>°C</span>`;\r\n        fl.innerText = data.currentConditions.feelslike + \"°C\";\r\n        wind.innerText = data.currentConditions.windgust + \"Km/h\";\r\n        humid.innerText = data.currentConditions.humidity + \"%\";\r\n\r\n\r\n        console.log(data);\r\n      })\r\n      .catch(function(error) {\r\n        console.error('Error fetching weather data:', error);\r\n      });\r\n}\r\n  \n\n//# sourceURL=webpack://odin-weather/./src/fetch.js?");
